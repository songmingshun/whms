...
namespace DTcms.DAL
{
    ...
    public partial class product
    {
        ...
        public bool Exists(int id)
        {
            ...
            strSql.Append("select count(1) from gm_dt_product_type");
        ...
        public bool Delete(int id)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append("delete from gm_dt_product_type ");
            strSql.Append(" where id=@id");
            SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)};
            parameters[0].Value = id;
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select  top 1 id,name,add_time from gm_dt_product_type ");
            strSql.Append(" where id=@id");
            SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)};
            parameters[0].Value = id;

            DTcms.Model.product model = new DTcms.Model.product();
        ...
        public DataSet GetList(string strWhere)
        {
            ...
            strSql.Append(" FROM gm_dt_product_type ");
            if (strWhere.Trim() != "")
            {
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select * FROM gm_dt_product_type");
            if (strWhere.Trim() != "")
            {
                strSql.Append(" where " + strWhere);
            }

...
namespace DTcms.DAL
{
    ...
    public partial class dept
    {
        ...
        public bool Exists(int id)
        {
            ...
            strSql.Append("select count(1) from gm_dt_dept");
        ...
        /// 检查部门名是否存在
        /// </summary>
        public bool Exists(string dept_name)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select count(1) from gm_dt_dept");
            strSql.Append(" where dept_name=@dept_name ");
            SqlParameter[] parameters = {
					new SqlParameter("@dept_name", SqlDbType.NVarChar,100)};
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("insert into gm_dt_dept(");
            strSql.Append("dept_name,add_time)");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update gm_dt_dept set ");
        ...
        public bool Delete(int id)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append("delete from gm_dt_dept ");
            strSql.Append(" where id=@id");
            SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)};
            parameters[0].Value = id;
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select  top 1 id,dept_name,add_time from gm_dt_dept ");
            strSql.Append(" where id=@id");
            SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)};
            parameters[0].Value = id;

            DTcms.Model.dept model = new DTcms.Model.dept();
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select id,dept_name,add_time ");
            strSql.Append(" FROM gm_dt_dept ");
            if (strWhere.Trim() != "")
            {
        ...
        public DataSet GetList(int Top, string strWhere, string filedOrder)
        {
            ...
            strSql.Append(" id,dept_name,add_time ");
            strSql.Append(" FROM gm_dt_dept ");
            if (strWhere.Trim() != "")
            {
                strSql.Append(" where " + strWhere);
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select * FROM gm_dt_dept");
            if (strWhere.Trim() != "")
            {
                strSql.Append(" where " + strWhere);
            }
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select top 1 dept_name from gm_dt_dept");
            strSql.Append(" where id=@id ");
            SqlParameter[] parameters = {

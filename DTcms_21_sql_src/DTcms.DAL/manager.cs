...
namespace DTcms.DAL
{
    ...
    public partial class manager
    {
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("insert into gm_dt_sysuser(");
            strSql.Append("role_id,role_type,user_name,user_pwd,real_name,telephone,email,is_lock,dept_id,add_time)");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update gm_dt_sysuser set ");
        ...
        public bool Delete(int id)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append("delete from gm_dt_sysuser_login_log ");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select  top 1 id,role_id,role_type,user_name,user_pwd,real_name,telephone,email,is_lock,dept_id,add_time from gm_dt_sysuser ");
            strSql.Append(" where id=@id");
            SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)};
            parameters[0].Value = id;
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select id from gm_dt_sysuser");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("SELECT A.id,A.role_id,A.role_type,A.user_name,A.real_name,A.telephone,A.email,A.is_lock,A.add_time,B.dept_name ");
            strSql.Append("FROM dbo.gm_dt_sysuser A LEFT JOIN dbo.gm_dt_dept B ON A.dept_id=B.id ");
            if (strWhere.Trim() != "")
            {
                strSql.Append(" where " + strWhere);
            }
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select top 1 real_name from gm_dt_sysuser");
        ...
        /// 获取权限值
        /// </summary>
        public int GetRoleValue(int role_id)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select top 1 role_value from gm_dt_sysuser_role");
            strSql.Append(" where id=@role_id ");
            SqlParameter[] parameters = {
					new SqlParameter("@role_id", SqlDbType.NVarChar,100)};

<%@ Page Language="C#" EnableEventValidation = "false"  AutoEventWireup="true" CodeBehind="dept_list.aspx.cs" Inherits="DTcms.Web.admin.working_hour.dept_list" %>
...
<form id="form1" runat="server">
    <div class="navigation">首页 &gt; 工时管理 &gt; 部门工时</div>
    <div class="tools_box">
	    <div class="tools_bar">
            <div class="search_box">
                <asp:Label ID="Label3" runat="server" >工单：</asp:Label>
                <asp:DropDownList ID="ddlJobOrder" runat="server" CssClass="select2"></asp:DropDownList>
<%--                <asp:Label ID="Label4" runat="server" >工单人员：</asp:Label>
                <asp:DropDownList ID="ddlJobOrderPerson" runat="server" CssClass="select2"></asp:DropDownList>--%>
                <asp:Label ID="Label1" runat="server" >起始时间：</asp:Label>
                ...
                <asp:Label ID="Label2" runat="server" >截止时间：</asp:Label>
...
<%--            <a href="my_edit.aspx?action=<%=DTEnums.ActionEnum.Add %>" class="tools_btn"><span><b class="add">填写工时</b></span></a>
    ...
    <ItemTemplate>
      <tr>
        <td align="center"><asp:HiddenField ID="hidId" Value='<%#Eval("id")%>' runat="server" /><%#new DTcms.BLL.manager().GetRealName(Eval("user_name").ToString())%></td>

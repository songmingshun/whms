<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="message_list.aspx.cs" Inherits="DTcms.Web.admin.message.message_list" %>
...
<form id="form1" runat="server">
    <div class="navigation">首页 &gt; 控制面板 &gt; 站内信列表</div>
    <div class="tools_box">
	    <div class="tools_bar">
            ...
            <a href="message_send.aspx" class="tools_btn"><span><b class="add">发送站内信</b></span></a>
        ...
        <div class="select_box">
            请选择：<asp:DropDownList ID="ddlType" runat="server" CssClass="select2" AutoPostBack="True" onselectedindexchanged="ddlType_SelectedIndexChanged">
                ...
                <asp:ListItem Selected="True" Value="2">收件箱</asp:ListItem>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="msgtable">
      <tr>
        ...
        <th width="12%" align="left">发件人</th>
        <th align="left">标题</th>
        <th width="12%">状态</th>
        <th width="16%" align="left">接收时间</th>
        <th width="6%">操作</th>
      </tr>
    </HeaderTemplate>
    <ItemTemplate>
      <tr>
        ...
        <td><%#Eval("post_user_name")%></td>
        <td><%#Eval("title")%></td>
        <%--<td align="center"><%#Convert.ToInt32(Eval("is_read")) == 1 ? "已阅读" : "未阅读"%></td>--%>
        <td align="center"><%#Eval("is_read").ToString().Trim() == "1" ? "<img title=\"已阅读\" src=\"../images/icon_correct.png\" />" : "<img title=\"未阅读\" src=\"../images/ico-3.png\" />"%></td>
        <td><%#Eval("post_time")%></td>
        <td align="center"><a href="message_detail.aspx?action=<%#DTEnums.ActionEnum.View %>&id=<%#Eval("id")%>&is_read=<%#Eval("is_read")%>">查看</a></td>

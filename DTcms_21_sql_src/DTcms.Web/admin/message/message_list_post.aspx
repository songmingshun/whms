<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="message_list_post.aspx.cs" Inherits="DTcms.Web.admin.message.message_list_post" %>
...
<form id="form1" runat="server">
    ...
    <ItemTemplate>
      <tr>
        ...
        <td align="center"><a href="message_detail.aspx?id=<%#Eval("id")%>">查看</a></td>

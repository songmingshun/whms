...
<form id="form1" runat="server">
    <div class="navigation">首页 &gt; 控制面板 &gt; 系统用户管理</div>
    <div class="tools_box">
	    <div class="tools_bar">
            ...
            <a href="manager_edit.aspx?action=<%=DTEnums.ActionEnum.Add %>" class="tools_btn"><span><b class="add">添加用户</b></span></a>
        ...
        <div class="select_box">
            请选择：<asp:DropDownList ID="ddlDeptId" runat="server" CssClass="select2" AutoPostBack="True" onselectedindexchanged="ddlDeptId_SelectedIndexChanged"></asp:DropDownList>&nbsp;
	    </div>
    </div>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="msgtable">
      <tr>
        ...
        <th width="12%" align="left">部门</th>
        <th width="10%" align="left">联系电话</th>
        <th width="20%" align="left">邮箱</th>
        <th width="13%" align="left">添加时间</th>
        <th width="6%">状态</th>
        <th width="6%">操作</th>
      </tr>
    </HeaderTemplate>

    ...
    public partial class role_edit : DTcms.Web.UI.ManagePage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!Page.IsPostBack)
            {
                ...
                rptList1.DataBind();
                rptList2.DataSource = GetWorkingHourList();
                rptList2.DataBind();
                rptList3.DataSource = GetJobOrderList();
                rptList3.DataBind();
                rptList4.DataSource = GetCustomerList();
                rptList4.DataBind();
        ...
        private void ShowInfo(int _id)
        {
            ...
            txtRoleValue.Text = Convert.ToString(model.role_value);
            //系统设置
            ...
            {
                string navName = ((HiddenField)rptList3.Items[i].FindControl("hidName")).Value;
                string navValue = ((HtmlInputCheckBox)rptList3.Items[i].FindControl("cblNavName")).Value;
                if (model.manager_role_values != null)
                {
                    Model.manager_role_value modelt = model.manager_role_values.Find(p => p.channel_name == navName && p.action_type == navValue);
                    if (modelt != null)
                    {
                        ((HiddenField)rptList3.Items[i].FindControl("hidId")).Value = modelt.id.ToString();
                        ((HtmlInputCheckBox)rptList3.Items[i].FindControl("cblNavName")).Checked = true;
                    }
                }
            }
            ...
            {
                string navName = ((HiddenField)rptList4.Items[i].FindControl("hidName")).Value;
                string navValue = ((HtmlInputCheckBox)rptList4.Items[i].FindControl("cblNavName")).Value;
                if (model.manager_role_values != null)
                {
                    Model.manager_role_value modelt = model.manager_role_values.Find(p => p.channel_name == navName && p.action_type == navValue);
                    if (modelt != null)
                    {
                        ((HiddenField)rptList4.Items[i].FindControl("hidId")).Value = modelt.id.ToString();
                        ((HtmlInputCheckBox)rptList4.Items[i].FindControl("cblNavName")).Checked = true;
                    }
                }
            }
            ////会员设置
        ...
        private void RoleBind()
        {
            ...
            {
                ddlRoleType.Items.Add(new ListItem("系统管理员", "1"));
            }
        ...
        private DataTable GetNavList()
        {
            ...
            //用户
            dt.Rows.Add("sys_manager", DTEnums.ActionEnum.View.ToString(), "查看用户");
            dt.Rows.Add("sys_manager", DTEnums.ActionEnum.Add.ToString(), "添加用户");
            dt.Rows.Add("sys_manager", DTEnums.ActionEnum.Edit.ToString(), "修改用户");
            dt.Rows.Add("sys_manager", DTEnums.ActionEnum.Delete.ToString(), "删除用户");
            //角色
            dt.Rows.Add("sys_role", DTEnums.ActionEnum.View.ToString(), "查看角色");
            dt.Rows.Add("sys_role", DTEnums.ActionEnum.Add.ToString(), "添加角色");
            dt.Rows.Add("sys_role", DTEnums.ActionEnum.Edit.ToString(), "修改角色");
            dt.Rows.Add("sys_role", DTEnums.ActionEnum.Delete.ToString(), "删除角色");
            //部门
            dt.Rows.Add("sys_dept", DTEnums.ActionEnum.View.ToString(), "查看部门");
            dt.Rows.Add("sys_dept", DTEnums.ActionEnum.Add.ToString(), "添加部门");
            dt.Rows.Add("sys_dept", DTEnums.ActionEnum.Edit.ToString(), "修改部门");
            dt.Rows.Add("sys_dept", DTEnums.ActionEnum.Delete.ToString(), "删除部门");
        ...
        /// 工时管理菜单
        /// </summary>
        private DataTable GetWorkingHourList()
        {
            DataTable dt = new DataTable();
            dt.Columns.Add("name", Type.GetType("System.String"));
            dt.Columns.Add("value", Type.GetType("System.String"));
            ...
            //我的工时
            dt.Rows.Add("sys_working_hour_my", DTEnums.ActionEnum.View.ToString(), "查看我的工时");
            dt.Rows.Add("sys_working_hour_my", DTEnums.ActionEnum.Add.ToString(), "添加我的工时");
            dt.Rows.Add("sys_working_hour_my", DTEnums.ActionEnum.Edit.ToString(), "修改我的工时");
            dt.Rows.Add("sys_working_hour_my", DTEnums.ActionEnum.Delete.ToString(), "删除我的工时");
            //部门工时
            dt.Rows.Add("sys_working_hour_dept", DTEnums.ActionEnum.View.ToString(), "查看部门工时");
            //dt.Rows.Add("sys_working_hour_dept", DTEnums.ActionEnum.Add.ToString(), "添加部门工时");
            //dt.Rows.Add("sys_working_hour_dept", DTEnums.ActionEnum.Edit.ToString(), "修改部门工时");
            //dt.Rows.Add("sys_working_hour_dept", DTEnums.ActionEnum.Delete.ToString(), "删除部门工时");
        ...
        private DataTable GetJobOrderList()
        {
            ...
            //我创建的工单
            dt.Rows.Add("sys_job_order_my", DTEnums.ActionEnum.View.ToString(), "查看我创建的工单");
            dt.Rows.Add("sys_job_order_my", DTEnums.ActionEnum.Add.ToString(), "添加我创建的工单");
            dt.Rows.Add("sys_job_order_my", DTEnums.ActionEnum.Edit.ToString(), "修改我创建的工单");
            dt.Rows.Add("sys_job_order_my", DTEnums.ActionEnum.Delete.ToString(), "删除我创建的工单");
            //我相关的工单
            dt.Rows.Add("sys_job_order_relevant", DTEnums.ActionEnum.View.ToString(), "查看我相关的工单");
            //dt.Rows.Add("sys_job_order_relevant", DTEnums.ActionEnum.Add.ToString(), "添加我相关的工单");
            //dt.Rows.Add("sys_job_order_relevant", DTEnums.ActionEnum.Edit.ToString(), "修改我相关的工单");
            //dt.Rows.Add("sys_job_order_relevant", DTEnums.ActionEnum.Delete.ToString(), "删除我相关的工单");
            //我审核的工单
            dt.Rows.Add("sys_job_order_review", DTEnums.ActionEnum.View.ToString(), "查看我审核的工单");
            //dt.Rows.Add("sys_job_order_review", DTEnums.ActionEnum.Add.ToString(), "添加我审核的工单");
            dt.Rows.Add("sys_job_order_review", DTEnums.ActionEnum.Edit.ToString(), "修改我审核的工单");
            //dt.Rows.Add("sys_job_order_review", DTEnums.ActionEnum.Delete.ToString(), "删除我审核的工单");
            //客户
            //dt.Rows.Add("sys_customer", DTEnums.ActionEnum.View.ToString(), "查看客户");
            //dt.Rows.Add("sys_customer", DTEnums.ActionEnum.Add.ToString(), "添加客户");
            //dt.Rows.Add("sys_customer", DTEnums.ActionEnum.Edit.ToString(), "修改客户");
            //dt.Rows.Add("sys_customer", DTEnums.ActionEnum.Delete.ToString(), "删除客户");
            return dt;
        }
        #endregion

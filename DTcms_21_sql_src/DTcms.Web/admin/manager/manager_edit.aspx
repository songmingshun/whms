        ...
        <table class="form_table">
            ...
            <tr>
                ...
                <td><asp:TextBox ID="txtUserName" runat="server" 
                        CssClass="txtInput normal required" minlength="2" maxlength="100"></asp:TextBox><label>*系统登录账号，建议使用非中文字符。</label></td>
            </tr>
            <tr>
                <th>登录密码：</th>
                <td><asp:TextBox ID="txtUserPwd" runat="server" CssClass="txtInput normal required" 
                        minlength="6" maxlength="100" TextMode="Password"></asp:TextBox><label>*登录的密码，至少6位。</label></td>
            </tr>
            <tr>
                <th>确认密码：</th>
                <td><asp:TextBox ID="txtUserPwd1" runat="server" CssClass="txtInput normal required" 
                        minlength="6" maxlength="100" TextMode="Password" equalTo="#txtUserPwd"></asp:TextBox><label>*请确认与登录密码相同。</label></td>
            </tr>
            <tr>
                <th>姓名：</th>
                <td><asp:TextBox ID="txtRealName" runat="server" CssClass="txtInput normal required" minlength="2" maxlength="30"></asp:TextBox><label>*系统用户的真实姓名或昵称。</label></td>
            </tr>
            <tr>
                <th>电话：</th>
                <td><asp:TextBox ID="txtTelephone" runat="server" CssClass="txtInput normal" minlength="2" maxlength="30"></asp:TextBox><label>手机或固定电话号。</label></td>
            </tr>
            <tr>
                <th>邮箱：</th>
                <td><asp:TextBox ID="txtEmail" runat="server" CssClass="txtInput normal email" minlength="2" maxlength="50"></asp:TextBox><label>例:jlgm@163.com。</label></td>
            </tr>
            <tr>
                <th>部门：</th>
                <td>
                    <asp:DropDownList ID="ddlDept" runat="server" CssClass="select2 required"/>
                </td>
            </tr>
            <tr>
                <th></th>

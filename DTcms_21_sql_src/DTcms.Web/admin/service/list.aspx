<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="list.aspx.cs" Inherits="DTcms.Web.admin.service.list" %>
...
<form id="form1" runat="server">
    <div class="navigation">首页 &gt; 控制面板 &gt; 服务类型</div>
    <div class="tools_box">
	    <div class="tools_bar">
            ...
            <a href="edit.aspx?action=<%=DTEnums.ActionEnum.Add %>" class="tools_btn"><span><b class="add">添加服务</b></span></a>

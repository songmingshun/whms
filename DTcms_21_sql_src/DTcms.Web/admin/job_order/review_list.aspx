<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="review_list.aspx.cs" Inherits="DTcms.Web.admin.job_order.review_list" %>
...
<form id="form1" runat="server">
    <div class="navigation">首页 &gt; 工单管理 &gt; 我审核的工单</div>
    <div class="tools_box">
	    <div class="tools_bar">
...
<%--            <asp:LinkButton ID="btnAgree" runat="server" CssClass="tools_btn"  
    ...
    <ItemTemplate>
      <tr>
        ...
        <td><a href="review_edit.aspx?action=<%#DTEnums.ActionEnum.Edit %>&id=<%#Eval("job_order_id")%>"><%#Eval("job_order_name")%></a></td>
        ...
        <td align="center"><a href="review_edit.aspx?action=<%#DTEnums.ActionEnum.Edit %>&id=<%#Eval("job_order_id")%>">详细</a></td>
      </tr>
    </ItemTemplate>
    <FooterTemplate>

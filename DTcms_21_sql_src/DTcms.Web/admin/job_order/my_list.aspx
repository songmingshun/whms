<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="my_list.aspx.cs" Inherits="DTcms.Web.admin.job_order.my_list" %>
...
<form id="form1" runat="server">
    <div class="navigation">首页 &gt; 工单管理 &gt; 我创建的工单</div>
    <div class="tools_box">
	    <div class="tools_bar">
    ...
    <ItemTemplate>
      <tr>
        ...
        <td><a href="my_edit.aspx?action=<%#DTEnums.ActionEnum.Edit %>&id=<%#Eval("job_order_id")%>"><%#Eval("job_order_name")%></a></td>
        <%--<td><%#new DTcms.BLL.manager_role().GetTitle(Convert.ToInt32(Eval("role_id")))%></td>--%>
        <%--<td><%#Eval("job_order_name")%></td>--%>
        <td><%#Eval("service_name")%></td>
        <%--<td><%#Eval("job_order_creator_id")%></td>--%>
        ...
        <%--<td><%#Eval("job_order_reviewer_id")%></td>--%>
        ...
        <td align="center"><a href="my_edit.aspx?action=<%#DTEnums.ActionEnum.Edit %>&id=<%#Eval("job_order_id")%>">详细</a></td>
      </tr>
    </ItemTemplate>
    <FooterTemplate>

...
//			{ text: '关闭菜单', click: itemclick }
    ...
    function itemclick(item) {
        switch (item.text) {
            case "系统首页":
                f_addTab('home', '系统首页', 'center.aspx');
                break;
            case "快捷导航":
                //调用函数
                break;
  ...
  <div position="top" class="header">
            <div class="header_box">
                <div class="header_right">
                    ...
                    <br /><a href="javascript:f_addTab('home','系统首页','center.aspx')">系统首页</a> | 
        ...
        <div position="left"  title="管理菜单" id="global_left_nav"> 
            <div title="工时管理" iconcss="menu-icon-model" class="l-scroll">
                <ul class="nlist">
                    <li><a href="javascript:f_addTab('my_workhours','我的工时','working_hour/my_list.aspx')">我的工时</a></li>
                    <li><a href="javascript:f_addTab('project_workhours','部门工时','working_hour/dept_list.aspx')">部门工时</a></li>
                </ul>
            </div>
<%--            <div title="频道管理" iconcss="menu-icon-model" class="l-scroll">
            ...
            <div title="工单管理" iconcss="menu-icon-member">
                <ul class="nlist">
                     <%if (IsAdminLevel("sys_job_order_my", DTEnums.ActionEnum.View.ToString()))
                      {%>
                    <li><a href="javascript:f_addTab('create_job_order','我创建的工单','job_order/my_list.aspx')">我创建的工单</a></li>
                    <%}
                        if (IsAdminLevel("sys_job_order_relevant", DTEnums.ActionEnum.View.ToString()))
                      { %>
                    <li><a href="javascript:f_addTab('relative_job_order','我相关的工单','job_order/relevant_list.aspx')">我相关的工单</a></li>
                    <%}
                        if (IsAdminLevel("sys_job_order_review", DTEnums.ActionEnum.View.ToString()))
                      { %>
                    <li><a href="javascript:f_addTab('review_job_order','我审核的工单','job_order/review_list.aspx')">我审核的工单</a></li>
                    <%} %>
...
<%--                        
            ...
            <div title="客户管理" iconcss="menu-icon-order">
                <ul class="nlist">
                    <%
                      if (IsAdminLevel("sys_customer", DTEnums.ActionEnum.View.ToString()))
                      { %>
                    <li><a href="javascript:f_addTab('sys_customer','客户信息维护','customer/list.aspx')">客户信息维护</a></li>
                    <%} %>
                </ul>
            </div>
            <%--<%} %>
            ...
            <div title="控制面板" iconcss="menu-icon-setting">
                <ul class="nlist">
                    ...
                    <%} if (IsAdminLevel("sys_log", DTEnums.ActionEnum.View.ToString()))
                      { %>
                    <li><a class="l-link" href="javascript:f_addTab('manager_log','日志管理','manager/manager_log.aspx')">日志管理</a></li>
                    <%} %>
                    ...
                    <%if (IsAdminLevel("sys_manager", DTEnums.ActionEnum.View.ToString()))
                      { %>
                    <li><a class="l-link" href="javascript:f_addTab('sys_manager','用户管理','manager/manager_list.aspx')">用户管理</a></li>
                    <%--<li><a class="l-link" href="javascript:f_addTab('sys_manager','管理员管理','manager/manager_list.aspx')">管理员管理</a></li>--%>
                    <%}%>
                    <%if (IsAdminLevel("sys_dept", DTEnums.ActionEnum.View.ToString()))
                      { %>
                    <li><a class="l-link" href="javascript:f_addTab('dept_list','部门管理','dept/dept_list.aspx')">部门管理</a></li>
                    <%} %>
                    <li><a class="l-link" href="javascript:f_addTab('message_list','站内信','message/message_list.aspx')">站内信</a></li>
                    <li><a class="l-link" href="javascript:f_addTab('product_list','产品类型管理','product/list.aspx')">产品类型管理</a></li>
                    <li><a class="l-link" href="javascript:f_addTab('service_list','服务类型管理','service/list.aspx')">服务类型管理</a></li>
                </ul>
            </div>
        </div>
        <div position="center" id="framecenter" toolsid="tab-tools-nav"> 
            <div tabid="home" title="系统首页" iconcss="tab-icon-home" style="height:300px" >
        ...
        <div position="bottom" class="footer">
            ...
            <div class="copyright">Copyright &copy; 2013 - 2015. jlguomai.com. All Rights Reserved.</div>
        </div>
    </div>
</form>
</body>

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="dept_list.aspx.cs" Inherits="DTcms.Web.admin.dept.dept_list" %>
...
<form id="form1" runat="server">
    <div class="navigation">首页 &gt; 控制面板 &gt; 部门管理</div>
    <div class="tools_box">
	    <div class="tools_bar">
            ...
            <a href="dept_edit.aspx?action=<%=DTEnums.ActionEnum.Add %>" class="tools_btn"><span><b class="add">添加部门</b></span></a>
    ...
    <ItemTemplate>
      <tr>
        ...
        <td><a href="dept_edit.aspx?action=<%#DTEnums.ActionEnum.Edit %>&id=<%#Eval("id")%>"><%#Eval("dept_name")%></a></td>
        <td><%#string.Format("{0:g}",Eval("add_time"))%></td>
        <td align="center"><a href="dept_edit.aspx?action=<%#DTEnums.ActionEnum.Edit %>&id=<%#Eval("id")%>">修改</a></td>
      </tr>
    </ItemTemplate>
    <FooterTemplate>

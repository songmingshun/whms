...
namespace DTcms.Web.admin.dept
{
    public partial class dept_list : DTcms.Web.UI.ManagePage
    {
        ...
        protected string CombSqlTxt(string _keywords)
        {
            ...
            {
                strTemp.Append(" and (dept_name like '%" + _keywords + "%' )");
            }
        ...
        {
            Response.Redirect(Utils.CombUrlTxt("dept_list.aspx", "keywords={0}", txtKeywords.Text));
        }
        ...
        protected void txtPageNum_TextChanged(object sender, EventArgs e)
        {
            ...
            Response.Redirect(Utils.CombUrlTxt("dept_list.aspx", "keywords={0}", this.keywords));
        }

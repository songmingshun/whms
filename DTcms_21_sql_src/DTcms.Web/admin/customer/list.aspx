<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="list.aspx.cs" Inherits="DTcms.Web.admin.customer.list" %>
...
<form id="form1" runat="server">
    <div class="navigation">首页 &gt; 客户管理 &gt; 客户信息维护</div>
    <div class="tools_box">
	    <div class="tools_bar">
            ...
            <a href="edit.aspx?action=<%=DTEnums.ActionEnum.Add %>" class="tools_btn"><span><b class="add">添加客户</b></span></a>
    ...
    <ItemTemplate>
      <tr>
        ...
        <td><a href="edit.aspx?action=<%#DTEnums.ActionEnum.Edit %>&id=<%#Eval("id")%>"><%#Eval("name")%></a></td>
        ...
        <td align="center"><a href="edit.aspx?action=<%#DTEnums.ActionEnum.Edit %>&id=<%#Eval("id")%>">查看</a></td>
      </tr>
    </ItemTemplate>
    <FooterTemplate>

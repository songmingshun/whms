...
<form id="form1" runat="server">
    <div class="navigation">首页 &gt; 控制面板 &gt; 产品类型</div>
    <div class="tools_box">
	    <div class="tools_bar">
            ...
            <a href="edit.aspx?action=<%=DTEnums.ActionEnum.Add %>" class="tools_btn"><span><b class="add">添加产品</b></span></a>
